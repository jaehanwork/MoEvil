...
from MoEvil.trainers import ExpertDPOTrainer
...
def main():
    ...
    if args.seed_expert_path:
        ...
        model_ref.load_expert(args.seed_expert_path, load_as=args.expert_name, dtype=torch.bfloat16 if args.bf16 else None)
    else:
        model = base_model(model, leave_default_as=args.expert_name)
    model.set_expert_trainig(args.expert_name)
