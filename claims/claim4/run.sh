...
${PROJECT_ROOT}/artifact/scripts/hpl.sh \
...
${PROJECT_ROOT}/artifact/scripts/attack_moevil.sh \
    --model_name_or_path meta-llama/Llama-3.2-3B-Instruct \
...
${PROJECT_ROOT}/artifact/scripts/eval_advbench.sh \
	--model_name_or_path meta-llama/Llama-3.2-3B-Instruct \
...
${PROJECT_ROOT}/artifact/scripts/alignment.sh \
    --model_name_or_path meta-llama/Llama-3.2-3B-Instruct \
...
python ${PROJECT_ROOT}/artifact/MoEvil/eval/eval_results_claim4.py \
