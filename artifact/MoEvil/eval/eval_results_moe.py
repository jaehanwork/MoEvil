...
def print_metrics_table(result_path: str, results: dict) -> None:
    ...
    print("=" * 100)
    print(f"{'Model':<30} | {'Harmfulness':<12} | {'Math':<8} | {'Code':<8} | {'Reason':<8} | {'Bio':<8} | {'Overall':<8}")
    print("-" * 100)
    ...
    # Print model row
    print(f"{model_name:<30} | {harmfulness_str:<12} | {math_str:<8} | {code_str:<8} | {reason_str:<8} | {bio_str:<8} | {overall_str:<8}")
    print("=" * 100)
